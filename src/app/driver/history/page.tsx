    ...
    <div className="min-h-screen bg-[#F7F9FB] py-10 px-4 sm:px-6 font-sans text-slate-700">
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-[#0A192F] mt-3">Historial de Viajes</h1>
            ...
            pools.map((pool) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-[#0A192F] to-[#1B365D] text-white p-4 sm:p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                    <div>
                  ...
                  <div className="p-5 sm:p-6 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        {pool.vehicle ? (
                          ...
                          <p className="text-sm text-red-500 italic">Vehículo no especificado (o eliminado)</p>
                        )}
                        <p className="text-sm text-slate-600">
                          <strong>Comisión Liquidada:</strong> <span className="text-emerald-600 font-bold">Cobrado</span>
                        </p>
                      </div>
                    ...
                    <div className="border-t border-[#D8DADC] pt-4">
                      <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Manifiesto de Pasajeros</h3>
